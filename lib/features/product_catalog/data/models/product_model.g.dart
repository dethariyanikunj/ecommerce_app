...
void _productModelSerialize(
  ...
  writer.writeLong(offsets[4], object.ratingCount);
...
ProductModel _productModelDeserialize(
  ...
  object.ratingCount = reader.readLong(offsets[4]);
...
extension ProductModelQueryFilter
  ...
  QueryBuilder<ProductModel, ProductModel, QAfterFilterCondition> ratingEqualTo(
    double value, {
    double epsilon = Query.epsilon,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProductModel, ProductModel, QAfterFilterCondition> ratingBetween(
    double lower,
    double upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension ProductModelQuerySortBy
  ...
  QueryBuilder<ProductModel, ProductModel, QAfterSortBy> sortByRating() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'rating', Sort.asc);
    });
  }

  QueryBuilder<ProductModel, ProductModel, QAfterSortBy> sortByRatingDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ProductModelQuerySortThenBy
  ...
  QueryBuilder<ProductModel, ProductModel, QAfterSortBy> thenByRating() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'rating', Sort.asc);
    });
  }

  QueryBuilder<ProductModel, ProductModel, QAfterSortBy> thenByRatingDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'rating', Sort.desc);
    });
  }
...
extension ProductModelQueryWhereDistinct
  ...
  QueryBuilder<ProductModel, ProductModel, QDistinct> distinctByRating() {
    return QueryBuilder.apply(this, (query) {
...
extension ProductModelQueryProperty
  ...
  QueryBuilder<ProductModel, double, QQueryOperations> ratingProperty() {
    return QueryBuilder.apply(this, (query) {
